...
export CLOUDFORMATION_STACK_NAME=stackset-roles
...
Prod URL for eu-central-1 is http://prod-f5d895c568a09d8c.elb.eu-central-1.amazonaws.com
curl response is Hello World!
Prod URL for eu-west-1 is http://prod-d447a6634dbb3e35.elb.eu-west-1.amazonaws.com
curl response is Hello World!
Prod URL for eu-west-2 is http://prod-fdd855104da6f735.elb.eu-west-2.amazonaws.com
curl response is Hello World!
